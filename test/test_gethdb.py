...
def test_retrieve_full_block():
    ...
    assert block['header']['parenthash'].hex() == "5c04a0fc96cd81f28cfcdb6e25a20266e78067f4712aa2fbb85f21435f7b068a"
    assert block['header']['uncleshash'].hex() == "99004d7c7986d2d0fbf1b678f96d7d4504d28f4b662b27a924f965683359a28c"
